    ...
    <BRow>
      <BCol lg="12">
        <BCard no-body>
                ...
                <BRow class="g-2">
                  <BCol>
                    <div class="position-relative mb-3">
                      ...
                      <BLink class="btn btn-link link-success btn-lg position-absolute end-0 top-0 material-shadow-none" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample"><i class="ri-mic-fill"></i></BLink>
                    </div>
                  </BCol>
                  <div class="col-auto">
          ...
          <BCardBody class="p-4">
            <BDropdown variant="transparent" right class="fw-medium text-reset mb-n1" no-caret style="position: absolute; right: 2px;">
                      ...
                      <BRow class="g-2">
                        ...
                        <BCol md="3" sm="6">
                          <div class="search-more-results rounded">
                            <BLink href="javascript:void(0);" class="d-block">
                ...
                <BRow class="pt-4">
                  <BCol lg="12">
                    <div class="images-menu mb-3">
                      <swiper class="swiper responsive-swiper rounded gallery-light pb-4" :loop="true" :slidesPerView="8" :spaceBetween="5">
                        <swiper-slide>
                      ...
                      <BCardBody>
                        <div class="d-sm-flex">
                          ...
                          <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                            <ul class="list-inline mb-2">
                              <li class="list-inline-item">
                                <BBadge variant="primary-subtle" class="bg-primary-subtle text-primary fs-11">Product</BBadge>
                              </li>
                            </ul>
                            <h5>
                      ...
                      <BCardBody>
                        <div class="d-sm-flex">
                          ...
                          <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                            <ul class="list-inline mb-2">
                              <li class="list-inline-item">
                                <BBadge variant="success-subtle" class="bg-success-subtle text-success fs-11">Business</BBadge>
                              </li>
                            </ul>
                            <h5>
                      ...
                      <BCardBody>
                        <div class="d-sm-flex">
                          ...
                          <div class="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                            <ul class="list-inline mb-2">
                              <li class="list-inline-item">
                                <BBadge variant="warning-subtle" class="bg-warning-subtle text-warning fs-11">Development</BBadge>
                              </li>
                            </ul>
                            <h5>
