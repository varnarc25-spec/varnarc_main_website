                        ...
                        <swiper :slides-per-view="3" :space-between="50">
                          <swiper-slide>
                            <div class="swiper-slide">
                              <BCard no-body class="profile-project-card shadow-none profile-project-success mb-0 material-shadow">
                                <BCardBody class="p-4">
                                  <div class="d-flex">
                    ...
                    <div class="acitivity-item py-3 d-flex">
                      ...
                      <div class="flex-grow-1 ms-3">
                        ...
                        <div class="avatar-group mb-2">
                          <BLink href="javascript: void(0);" class="avatar-group-item material-shadow" data-bs-toggle="tooltip"
