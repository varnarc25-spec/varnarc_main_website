          ...
          <BCol sm="auto" class="ms-auto">
            <div class="list-grid-nav hstack gap-1">
              <BButton type="button" id="grid-view-button"
                class="btn btn-soft-info nav-link btn-icon fs-14 active filter-button material-shadow-none"><i class="ri-grid-fill"></i>
              </BButton>
              <BButton type="button" id="list-view-button"
                class="btn btn-soft-info nav-link  btn-icon fs-14 filter-button material-shadow-none"><i class="ri-list-unordered"></i>
              </BButton>
              <BDropdown variant="soft-info" right class="btn-icon material-shadow-none fs-14" no-caret>
                      ...
                      <BCol class="team-settings">
                        <BRow>
                          ...
                          <div class="dropdown col text-end">
                            <BDropdown variant="link" toggle-class="m-n3 text-light" no-caret menu-class="dropdown-menu-end">
