                ...
                <div class="flex-shrink-0">
                  <div class="d-flex gap-1 align-items-center">
                    ...
                    <BDropdown variant="link"
                      ...
                      View</Link>
                      <Link class="dropdown-item" href="/apps/projects-create"><i
          ...
          <BCardBody>
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="flex-shrink-0">
                  <div class="d-flex gap-1 align-items-center my-n2">
                    <BButton type="button" variant="transparent" class="btn avatar-xs p-0 favourite-btn active material-shadow-none"
                      @click="toggleFavourite">
                      <span class="avatar-title bg-transparent fs-15">
                        <i class="ri-star-fill"></i>
                      </span>
            ...
            <div class="py-3">
              ...
              <div class="d-flex align-items-center mt-3">
                ...
                <div class="avatar-group">
                  <BLink href="javascript: void(0);" v-for="( subItem, index ) of  item.subItem " :key="index"
                    class="avatar-group-item material-shadow" v-b-tooltip.hover title="Donna Kline">
          ...
          <BCardBody>
            <div class="p-3 mt-n3 mx-n3 bg rounded-top" :class="'bg-' + item.color">
              <div class="d-flex gap-1 align-items-center justify-content-end my-n2">
                ...
                <BDropdown variant="link" toggle-class="btn btn-link text-muted p-1 mt-n2 py-0 text-decoration-none fs-15"
                  no-caret menu-class="dropdown-menu-end" :offset="{ alignmentAxis: -130, crossAxis: 0, mainAxis: 10 }">
                  <template #button-content>
                    <MoreHorizontalIcon class="icon-sm"></MoreHorizontalIcon>
                  </template>
                  <Link class="dropdown-item" href="/apps/projects-overview"><i
