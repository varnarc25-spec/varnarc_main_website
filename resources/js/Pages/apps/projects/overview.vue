                                ...
                                <BCard no-body>
                                    <BCardBody>
                                        <div class="text-muted">
                                            ...
                                            <div>
                                                <BButton type="button" variant="link" class="link-success p-0 material-shadow-none">Read
                                                    more</BButton>
                                            </div>
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="flex-shrink-0 ms-2">
                                                                    <div class="d-flex gap-1">
                                                                        ...
                                                                        <BDropdown variant="link" toggle-class="btn btn-icon btn-sm fs-18 text-muted" no-caret menu-class="dropdown-menu-end" :offset="{ alignmentAxis: -130, crossAxis: 0, mainAxis: 10 }">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="flex-shrink-0 ms-2">
                                                                    <div class="d-flex gap-1">
                                                                        ...
                                                                        <BDropdown variant="link" toggle-class="btn btn-icon btn-sm fs-18 material-shadow-none text-muted" no-caret menu-class="dropdown-menu-end" :offset="{ alignmentAxis: -130, crossAxis: 0, mainAxis: 10 }">
                                                                            <template #button-content>
                                                                                <i class="ri-more-fill"></i>
                                                                            </template>
                                                                            <BDropdownItem><i class="ri-pencil-fill align-bottom me-2 text-muted"></i>
                                ...
                                <BCard no-body>
                                    <BCardHeader class="align-items-center d-flex py-0">
                                        ...
                                        <div class="flex-shrink-0">
                                            <BDropdown variant="link" class="card-header-dropdown" toggle-class="text-reset dropdown-btn" no-caret menu-class="dropdown-menu-end" aria-haspopup="true">
                                        ...
                                        <form class="mt-4">
                                            <BRow class="g-3">
                                                ...
                                                <BCol cols="12" class="text-end">
                                                    <BButton type="button" variant="ghost-secondary" class="btn-icon waves-effect me-1 material-shadow-none">
                            ...
                            <BCol xl="3" lg="4">
                                ...
                                <BCard no-body>
                                    <BCardHeader class="align-items-center d-flex border-bottom-dashed">
                                        ...
                                        <div class="flex-shrink-0">
                                            <BButton type="button" variant="soft-danger" size="sm" class="material-shadow-none"><i class="ri-share-line me-1 align-bottom"></i> Invite Member
                                            </BButton>
                                        </div>
                                    </BCardHeader>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-shrink-0">
                                                        <div class="d-flex align-items-center gap-1">
                                                            <BButton type="button" variant="light" size="sm" class="material-shadow-none">Message
                                                            </BButton>

                                                            <BDropdown variant="link" toggle-class="btn btn-icon btn-sm fs-16 text-muted material-shadow-none" no-caret menu-class="dropdown-menu-end" :offset="{ alignmentAxis: -130, crossAxis: 0, mainAxis: 10 }">
                                                                <template #button-content>
                                                                    <i class="ri-more-fill"></i>
                                                                </template>
                                ...
                                <BCard no-body>
                                    <BCardHeader class="align-items-center d-flex border-bottom-dashed">
                                        ...
                                        <div class="flex-shrink-0">
                                            <BButton type="button" variant="soft-info" size="sm"><i class="ri-upload-2-fill me-1 align-bottom"></i> Upload</BButton>
                                        </div>
                                    </BCardHeader>
                                        ...
                                        <table class="table table-borderless align-middle mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>12 Dec 2021</td>
                                                    <td>
                                                        <BDropdown variant="link" toggle-class="btn btn-soft-secondary btn-sm btn-icon" no-caret menu-class="dropdown-menu-end" :offset="{ alignmentAxis: -130, crossAxis: 0, mainAxis: 10 }">
                                                            <template #button-content>
                                                                <i class="ri-more-fill"></i>
                                                            </template>
                                    ...
                                    <BRow class="align-items-center team-row">
                                        <div class="col team-settings">
                                            <BRow class="align-items-center">
                                                ...
                                                <BDropdown variant="link" toggle-class="text-end" no-caret menu-class="dropdown-menu-end">
                                                    <template #button-content>
