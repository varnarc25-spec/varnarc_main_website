                ...
                <BRow class="mb-4">
                    ...
                    <BCol order="2" order-sm="3" class="col-auto ms-auto">
                        <div class="hstack gap-2">
                            <BButton-group>
                                <BButton variant="soft-danger" class="btn-icon fw-semibold minimal-border"><i class="ri-arrow-go-back-line"></i></BButton>
                                <BButton variant="soft-success" class="btn-icon fw-semibold minimal-border"><i class="ri-arrow-go-forward-line"></i></BButton>
                            </BButton-group>
                        </div>
                    </BCol>
                </BRow>
        ...
        <BModal v-model="projectModal" hide-footer title="Create Project" class="v-modal-custom" modal-class="zoomIn" centered header-class="p-3 bg-success-subtle">
            <BForm id="projectForm" autocomplete="off" class="needs-validation createProject-form" novalidate>
                ...
                <div class="hstack gap-2 justify-content-end">
                    <BButton type="button" variant="ghost-success" class="material-shadow-none" id="addProjectBtn-close" @click="projectModal = false"><i class="ri-close-line align-bottom"></i> Close</BButton>
