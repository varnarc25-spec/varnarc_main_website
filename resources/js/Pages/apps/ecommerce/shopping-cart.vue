    ...
    <BRow class="mb-3">
      <BCol xl="8">
        ...
        <div class="text-end mb-4">
          <Link href="/ecommerce/checkout" class="btn btn-success btn-label right ms-auto"><i class="ri-arrow-right-line label-icon align-bottom fs-16 ms-2"></i>
          Checkout</Link>
        </div>
      </BCol>
          ...
          <BAlert variant="danger" :model-value="true" class="border-dashed" role="alert" show>
            <div class="d-flex align-items-center">
              ...
              <div class="ms-2">
                ...
                <button type="button" class="btn ps-0 btn-sm material-shadow-none btn-link text-danger text-uppercase">
                  Add Gift Wrap
                </button>
              </div>
            </div>
