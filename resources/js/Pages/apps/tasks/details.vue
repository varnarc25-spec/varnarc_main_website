                        ...
                        <ul class="list-unstyled vstack gap-3 mb-0">
                            <li>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-shrink-0">
                                        <BDropdown variant="link" toggle-class="btn btn-icon btn-sm fs-16 text-muted material-shadow-none"
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-shrink-0 ms-2">
                                        <div class="d-flex gap-1">
                                            ...
                                            <BDropdown variant="link" toggle-class="btn btn-icon text-muted btn-sm fs-18 material-shadow-none"
                                                no-caret menu-class="dropdown-menu-end">
                                                <template #button-content>
                ...
                <BCard no-body>
                    <BCardBody>
                        <BTabs nav-class="nav-tabs-custom card-header-tabs border-bottom-0">
                            <BTab active title="Comments (5)" class="nav-item pt-4" style="position: relative; top: 10px;">
                                ...
                                <simplebar data-simplebar style="height: 508px;" class="px-3 mx-n3 mb-2">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h5 class="fs-13">
                                                <Link href="/pages/profile">Tonya Noble</Link> <small class="text-muted">26
                                                    min ago</small>
                                            </h5>
                            ...
                            <BTab title="Time Entries (9 hrs 13 min)" class="nav-item pt-4"
