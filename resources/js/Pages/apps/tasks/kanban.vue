                ...
                <BRow class="g-2">
                    ...
                    <div class="col-auto ms-sm-auto">
                        <div class="avatar-group" id="newMembar">
                            <BLink href="javascript: void(0);" class="avatar-group-item material-shadow" v-b-tooltip.hover title="Nancy">
                                <img src="@assets/images/users/avatar-5.jpg" alt="" class="rounded-circle avatar-xs">
                            </BLink>
                            <BLink href="javascript: void(0);" class="avatar-group-item material-shadow" v-b-tooltip.hover title="Frank">
                                <img src="@assets/images/users/avatar-3.jpg" alt="" class="rounded-circle avatar-xs">
                            </BLink>
                            <BLink href="javascript: void(0);" class="avatar-group-item material-shadow" v-b-tooltip.hover title="Tonya">
                                <img src="@assets/images/users/avatar-10.jpg" alt="" class="rounded-circle avatar-xs">
                            </BLink>
                            <BLink href="javascript: void(0);" class="avatar-group-item material-shadow" v-b-tooltip.hover title="Thomas">
                                <img src="@assets/images/users/avatar-8.jpg" alt="" class="rounded-circle avatar-xs">
                            </BLink>
                            <BLink href="javascript: void(0);" class="avatar-group-item material-shadow" v-b-tooltip.hover title="Herbert">
                                <img src="@assets/images/users/avatar-2.jpg" alt="" class="rounded-circle avatar-xs">
                            </BLink>
                            <BLink class="avatar-group-item material-shadow" @click="modalShow = !modalShow">
                                <div class="avatar-xs">
            ...
            <div class="tasks-list">
                <div class="d-flex mb-3">
                    ...
                    <div class="flex-shrink-0">
                        <BDropdown variant="link" class="card-header-dropdown" toggle-class="p-0" no-caret menu-class="dropdown-menu-end" :offset="{ alignmentAxis: -70, crossAxis: 0, mainAxis: 10 }">
                            ...
                            <BCard no-body class="tasks-box" v-for="(data, index) of unassigned" :key="index">
                                <BCardBody>
                                    <div class="d-flex mb-2">
                                        ...
                                        <BDropdown variant="link" toggle-class="text-muted p-0" no-caret :offset="{ alignmentAxis: -130, crossAxis: 0, mainAxis: 10 }">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-shrink-0">
                                            <div class="avatar-group">
                                                <BLink href="javascript: void(0);" v-for="(item, index) of data.users" :key="index" class="avatar-group-item material-shadow" v-b-tooltip.hover title="Alexis">
