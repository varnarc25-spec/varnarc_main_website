  ...
  <Layout>
            ...
            <div class="d-flex justify-content-between">
              <div>
                ...
                <p class="mb-0 text-muted">
                  <BBadge class="bg-light text-success mb-0"><i class="ri-arrow-up-line align-middle"></i> 8.24 %
                  </BBadge> 7 last week
                </p>
              </div>
              <div>
          ...
          <BCardBody>
            <div class="d-flex justify-content-between">
              <div>
                ...
                <p class="mb-0 text-muted">
                  <BBadge class="bg-light text-danger mb-0"><i class="ri-arrow-down-line align-middle"></i> 25.87 %
                  </BBadge> 7 last week
                </p>
              </div>
              <div>
                ...
                <table class="table align-middle table-nowrap mb-0">
                  ...
                  <tbody class="list form-check-all">
                    <tr v-for="(data, index) of resultQuery" :key="index">
                      ...
                      <td class="status">
                        <BBadge variant="bg-success-subtle text-success" :class="{
                      ...
                      <td>
                        <BDropdown variant="soft-secondary" size="sm" no-caret menu-class="dropdown-menu-end">
    ...
    <BModal v-model="createApiModal" id="showModal" title-class="exampleModalLabel" hide-footer class="v-modal-custom"
      ...
      <div class="hstack gap-2 justify-content-end mt-3">
        ...
        <BButton variant="primary" id="createApimodal-btn" @click="(e) => handleApikeydetails(e)">Create API</BButton>
