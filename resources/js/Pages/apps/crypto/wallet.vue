          ...
          <BCardHeader>
            <div class="d-flex align-items-center">
              ...
              <div class="toolbar d-flex align-items-start justify-content-center flex-wrap gap-2">
                <BButton type="button" variant="soft-primary" size="sm" class="timeline-btn material-shadow-none"
                  id="one_month">
                  1M
                </BButton>
                <BButton type="button" variant="soft-primary" size="sm" class="timeline-btn material-shadow-none"
                ...
                <BButton type="button" variant="soft-primary" size="sm" class="timeline-btn material-shadow-none active"
                  id="all">
                  ALL
                </BButton>
              </div>
          ...
          <template v-for="(item, index) of cryptoSlider" :key="index">
            <swiper-slide>
              <BCard no-body>
                <BCardBody>
                  <div class="float-end">
                    <BDropdown variant="link" toggle-class="fs-18" no-caret menu-class="dropdown-menu-end"
                  ...
                  <tr v-for="(data, index) of resultQuery" :key="index">
                    ...
                    <td>
                      <div class="d-flex align-items-center fw-medium">
                        ...
                        <BLink href="javascript:void(0)" class="currency_name">{{ data.currency_name }}</BLink>
                      </div>
                    </td>
