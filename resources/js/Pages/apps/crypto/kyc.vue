              ...
              <BRow class="g-3">
                ...
                <BCol lg="12">
                  <div class="d-flex align-items-start gap-3 mt-3">
                    <BButton type="button" variant="primary" class="btn-label right ms-auto nexttab" @click="tabIndex++">
              ...
              <BRow>
                ...
                <BCol lg="12">
                  <div class="hstack align-items-start gap-3 mt-4">
                    ...
                    <BButton variant="primary" type="button" class="btn-label right ms-auto nexttab" @click="tabIndex++">
              ...
              <BRow class="text-center justify-content-center">
                <BCol lg="11">
                  ...
                  <div class="hstack justify-content-center gap-2">
                    ...
                    <BButton type="button" variant="primary" @click="tabIndex = 0">
