                ...
                <div class="p-4 d-flex flex-column h-100">
                    ...
                    <simplebar class="mx-n4 px-4 email-menu-sidebar-scroll">
                        ...
                        <div class="border-top border-top-dashed pt-3 mt-3">
                            <BLink href="#" class="btn btn-icon btn-sm btn-soft-info btn-rounded float-end material-shadow-none"><i class="bx bx-plus fs-16"></i></BLink>
                        ...
                        <BRow class="mt-n2 mb-3 mb-sm-0">
                            ...
                            <BCol order="3" order-sm="2" sm>
                                <div class="hstack gap-sm-1 align-items-center flex-wrap email-topbar-link">
                                    ...
                                    <BButton type="button" variant="ghost-secondary" size="sm" class="btn-icon fs-16 material-shadow-none" v-b-tooltip.hover title="Labels">
                            ...
                            <div class="col-auto order-2 order-sm-3">
                                <div class="d-flex gap-sm-1 email-topbar-link">
                                    <BButton type="button" variant="ghost-secondary" size="sm" class="btn-icon fs-16 material-shadow-none">
                        ...
                        <BRow>
                            ...
                            <div class="col-auto">
                                <div class="hstack gap-sm-1 align-items-center flex-wrap email-topbar-link">
                                    ...
                                    <BButton type="button" variant="ghost-secondary" class="btn-icon btn-sm fs-16 material-shadow-none remove-mail" @click="removeModal = !removeModal">
                                        <i class="ri-delete-bin-5-fill align-bottom"></i>
                                    </BButton>
                                    <div class="dropdown">
