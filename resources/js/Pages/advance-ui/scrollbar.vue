                                ...
                                <div class="mx-n3">
                                    <simplebar data-simplebar data-simplebar-auto-hide="false"
                                        ...
                                        <div class="d-flex align-items-center py-3">
                                            ...
                                            <div class="flex-shrink-0 ms-2">
                                                <BButton variant="outline-success" size="sm" type="button" class="material-shadow-none"><i
                                        ...
                                        <div class="d-flex align-items-center py-3">
                                            ...
                                            <div class="flex-shrink-0 ms-2">
                                                <BButton variant="outline-success" class="material-shadow-none" size="sm" type="button"><i
                                                        class="ri-user-add-line align-middle"></i></BButton>
                                            </div>
                                        </div>
