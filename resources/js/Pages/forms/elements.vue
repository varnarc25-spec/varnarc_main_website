                        ...
                        <div class="live-preview">
                            <div>
                                ...
                                <BRow class="g-3">
                                    ...
                                    <BCol lg="6">
                                        <div class="input-group">
                                            <BButton variant="outline-primary" type="button" id="button-addon1">Button</BButton>
                                    ...
                                    <BCol lg="6">
                                        <div class="input-group">
                                            ...
                                            <BButton variant="outline-success" type="button" id="button-addon2">Button</BButton>
                                        </div>
                                    </BCol>
                                    <BCol lg="6">
                                        <div class="input-group">
                            ...
                            <div>
                                ...
                                <BRow class="g-3">
                                    ...
                                    <BCol lg="6">
                                        <BInputGroup>
                                            <BFormInput type="text" class="form-control" aria-label="Text input with dropdown button"></BFormInput>
                                            <BDropdown variant="success" text="Dropdown" class="dropdown-menu-end">
                                                <BDropdownItem href="#">Action</BDropdownItem>
                                                <BDropdownItem href="#">Another action</BDropdownItem>
                                                <BDropdownItem href="#">Something else here</BDropdownItem>
                                                <BDropdownDivider></BDropdownDivider>
                                    ...
                                    <BCol lg="12">
                                        <BInputGroup>
                                            ...
                                            <BDropdown variant="outline-secondary" text="Dropdown" class="dropdown-menu-end">
                                                <BDropdownItem href="#">Action</BDropdownItem>
                                                <BDropdownItem href="#">Another action</BDropdownItem>
                                                <BDropdownItem href="#">Something else here</BDropdownItem>
                                                <BDropdownDivider></BDropdownDivider>
                        ...
                        <div class="live-preview">
                            <div>
                                ...
                                <BRow class="g-3">
                                    ...
                                    <BCol lg="6">
                                        <BInputGroup>
                                            <BFormSelect id="inputGroupSelect02">
                                                <option value="">Choose...</option>
                                                <option value="1">One</option>
                                                <option value="2">Two</option>
                                                <option value="3">Three</option>
                                    ...
                                    <BCol lg="6">
                                        <BInputGroup>
                                            ...
                                            <BFormSelect id="inputGroupSelect03" aria-label="Example select with button addon">
                                                <option value="">Choose...</option>
                                                <option value="1">One</option>
                                                <option value="2">Two</option>
                                                <option value="3">Three</option>
                                    ...
                                    <BCol lg="6">
                                        <BInputGroup>
                                            <BFormSelect id="inputGroupSelect04" aria-label="Example select with button addon">
                                                <option value="">Choose...</option>
                                                <option value="1">One</option>
                                                <option value="2">Two</option>
                                                <option value="3">Three</option>
                            ...
                            <div class="mt-4">
                                ...
                                <BRow class="g-3">
                                    ...
                                    <BCol lg="6">
                                        <div class="input-group">
                                            <BButton variant="outline-primary" type="button" id="inputGroupFileAddon03">Button</BButton>
                                    ...
                                    <BCol lg="6">
                                        <div class="input-group">
                                            ...
                                            <BButton variant="outline-success" type="button" id="inputGroupFileAddon04">Button</BButton>
                                        </div>
                                    </BCol>
                                </BRow>
                            </div>
