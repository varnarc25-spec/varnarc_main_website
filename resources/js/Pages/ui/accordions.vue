          ...
          <BCardBody>
            ...
            <div class="live-preview">
              <BAccordion flush id="accordionFlushExample">
                <BAccordionItem title="How do I set up my profile ?" visible class="material-shadow">
                ...
                <BAccordionItem title="What can I do with my project ?" class="material-shadow">
                ...
                <BAccordionItem title="Where can I go to edit voice settings" class="material-shadow">
        ...
        <BCard no-body>
          ...
          <BCardBody>
            ...
            <BAccordion class="custom-accordionwithicon accordion-secondary" id="accordionWithicon">
              <BAccordionItem visible class="material-shadow">
                <template #title>
              ...
              <BAccordionItem class="material-shadow">
                <template #title>
          ...
          <BCardBody>
            ...
            <div class="live-preview">
              <BAccordion class="custom-accordionwithicon-plus" id="accordionWithplusicon">
                <BAccordionItem title="What is User Interface Design?" visible class="material-shadow">
                ...
                <BAccordionItem title="What is Digital Marketing?" class="material-shadow">
          ...
          <BCardBody>
            ...
            <div class="live-preview">
              <BAccordion class="custom-accordionwithicon accordion-border-box" id="accordionnesting">
                <BAccordionItem title="How Do I Add Contacts/Subscribers?" visible class="material-shadow">
                  ...
                  <BAccordion class="
                    ...
                    <BAccordionItem title="How Do I Search For Contacts?" visible class="material-shadow">
                      ...
                      <BAccordion class="
                        ...
                        <BAccordionItem title="How do I reset my digital tide watch ?" class="material-shadow">
                    ...
                    <BAccordionItem title="How Do I Delete a Contact From My List?" class="material-shadow">
                ...
                <BAccordionItem title="How Does Personalization Work?" class="material-shadow">
                ...
                <BAccordionItem title="What Happens When I Run Out of Messages?" class="material-shadow">
              ...
              <BRow>
                <BCol xxl="6">
                  <BAccordion class="custom-accordionwithicon accordion-fill-success" id="accordionFill">
                    <BAccordionItem title="What are webhooks?" visible class="material-shadow">
                    ...
                    <BAccordionItem title="Where can I find my Textword ID?" class="material-shadow">
                    ...
                    <BAccordionItem title="Where is your API documentation?" class="material-shadow">
                ...
                <BCol xxl="6">
                  <BAccordion class="custom-accordionwithicon accordion-flush accordion-fill-secondary"
                    id="accordionFill2">
                    <BAccordionItem title="How Does Age Verification Work?" visible class="material-shadow">
                    ...
                    <BAccordionItem title="What Kind of List Growth Should I Expect?" class="material-shadow">
