    ...
    <BCard no-body class="card-height-100">
        <BCardHeader class="align-items-center d-flex py-0">
            ...
            <div class="flex-shrink-0">
                <BDropdown variant="link" class="card-header-dropdown" toggle-class="text-reset dropdown-btn" no-caret menu-class="dropdown-menu-end" aria-haspopup="true" :offset="{ alignmentAxis: -75, crossAxis: 0, mainAxis: 0 }">
                    <template #button-content><span class="text-muted"><i class="ri-settings-4-line align-middle me-1"></i>Setting <i class="mdi mdi-chevron-down ms-1"></i></span>
                    </template>
                            ...
                            <div class="conversation-list">
                                ...
                                <div class="user-chat-content">
                                    <div class="ctext-wrap">
                                        ...
                                        <BDropdown variant="link" class="card-header-dropdown align-self-start message-box-drop" toggle-class="text-reset dropdown-btn" no-caret menu-class="dropdown-menu" aria-haspopup="true">
