        ...
        <BCard no-body class="card-height-100">
            <BCardHeader class="align-items-center d-flex">
                ...
                <div class="flex-shrink-0">
                    <BLink href="#!" class="btn btn-soft-primary btn-sm material-shadow-none">View All Companies <i
                    ...
                    <table class="table table-centered table-hover align-middle table-nowrap mb-0">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <BLink href="#!" class="btn btn-link btn-sm material-shadow-none">View More <i
                                            class="ri-arrow-right-line align-bottom"></i></BLink>
                                </td>
                            </tr>
                            <tr>
